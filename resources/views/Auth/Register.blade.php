...
<body class="register-page bg-body-secondary">
    <div class="register-box">
        <div class="register-logo"> <a href="../index2.html"><b>Peduli</b>Diri</a> </div> <!-- /.register-logo -->
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="../index3.html" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="d-grid gap-2"> <button type="submit" class="btn btn-primary"><a href="/Dashboard" style="text-decoration: none; color: white;">Sign In</a></button> </div>
                        </div> <!-- /.col -->
                    </div> <!--end::Row-->
                </form>
