                    ...
                    <!--begin::User Image-->
                        <li class="user-header text-bg-primary"> <img src="{{ asset('assets') }}/img/user2-160x160.jpg" class="rounded-circle shadow" alt="User Image">
                            <p>
                                ...
                                <small>Member since Nov. 20351</small>
                            </p>
                        </li> <!--end::User Image-->

                    <!--begin::Menu Body-->
                    <!--begin::Menu Footer-->
                        <li class="user-footer"> <a href="/Profile" class="btn btn-default btn-flat">Profile</a> <a href="/" class="btn btn-default btn-flat float-end">Sign out</a> </li> <!--end::Menu Footer-->
                    </ul>
